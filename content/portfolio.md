...
- **Recent focus:** design systems & fintech products
- **AI fluency:** uses AI as part of the design workflow (e.g. Claude + Figma MCP for design-to-code handoff)
- **Industries:** crypto, consulting, IoT, fashion
- **Target audience:** recruiters, design directors, design managers, design leads, founders looking for designers — evaluating for junior product design roles (or open to this experience level)
...
- **About page**
- **Work detail sub-pages:** one per project

## Projects to Showcase

### 1. Crypto.com — Feature Flow Revamp (v1.2 → v1.3)
- Covered: crypto vs. stock asset detail pages, asset labels distinguishing tokenized stocks/perps, analyst ratings, crypto basket vs. whale basket details (rebalancing/allocation alerts), DCA calculator
- Timeline: under 2 weeks before company priorities shifted — framed as an early direction, not a fully polished solution
- Process: designed in Figma; used MCP to push a PR to a shared repo; reviewed on simulator; shared videos + design rationale with the team before merging
- `[Further detail: PLACEHOLDER — to be walked through]`

### 2. Crypto.com — Design System Revamp
- Companion project to the feature flow revamp above, covering the underlying design system
- `[Further detail: PLACEHOLDER — to be walked through]`

### 3. AI Tool — Screenshot-to-Figma Converter
- An AI tool built to convert screenshots into Figma output
- `[Further detail: PLACEHOLDER — to be walked through]`

### 4. Tokenized Stocks on Crypto.com
